...
export default function TimeBlockPlanner() {
  ...
  const removeBlock = (id) => {
    updateTimeBlocks(
      selectedDay,
      dayBlocks.filter((block) => block.id !== id)
    );
  };
  ...
  return (
    <section id="time-blocking" className="rounded-3xl border border-white/10 bg-white/[0.03] p-6">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          {block.source !== 'google' && (
                            <button
                              ...
                              className="rounded-full border border-white/10 p-2 text-base-300 transition hover:bg-white/10 hover:text-white"
                            >
